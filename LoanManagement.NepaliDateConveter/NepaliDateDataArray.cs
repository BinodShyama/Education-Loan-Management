    ...
    public static class NepaliDateDataArray
    {
        public static int[] GetNepaliDateDataArray(int year)
        {
            switch (year)
            {
                ...
                case 2025:
                    {
                        return new int[15] { 2081, 17, 29, 30, 29, 31, 31, 31, 32, 31, 31, 31, 30, 29, 30 };
                    }

                case 2026:
                    {
                        return new int[15] { 2082, 18, 30, 29, 30, 30, 31, 31, 32, 31, 31, 31, 30, 29, 30 };
                    }

                case 2027:
                    {
                        return new int[15] { 2083, 17, 30, 29, 30, 30, 31, 32, 31, 32, 31, 30, 30, 30, 29 };
                    }

                case 2028:
                    {
                        return new int[15] { 2084, 16, 29, 29, 30, 31, 30, 32, 31, 32, 31, 30, 30, 30, 29 };
                    }

                case 2029:
                    {
                        return new int[15] { 2085, 17, 29, 30, 29, 31, 31, 31, 32, 31, 31, 31, 30, 29, 30 };
                    }

                case 2030:
                    {
                        return new int[15] { 2086, 17, 30, 29, 30, 30, 31, 31, 32, 32, 31, 30, 30, 29, 30 };
                    }

                case 2031:
                    {
                        return new int[15] { 2087, 17, 30, 29, 30, 30, 31, 32, 31, 32, 31, 30, 30, 30, 29 };
                    }

                case 2032:
                    {
                        return new int[15] { 2088, 16, 29, 29, 30, 31, 30, 32, 31, 32, 31, 30, 30, 30, 29 };
                    }

                case 2033:
                    {
                        return new int[15] { 2089, 17, 29, 30, 29, 31, 31, 31, 32, 31, 31, 31, 30, 29, 30 };
                    }

                case 2034:
                    {
                        return new int[15] { 2090, 17, 30, 29, 30, 30, 31, 31, 32, 32, 31, 30, 30, 29, 30 };
                    }

                case 2035:
                    {
                        return new int[15] { 2091, 17, 30, 29, 30, 30, 31, 32, 31, 32, 31, 30, 30, 30, 29 };
                    }

                case 2036:
                    {
                        return new int[15] { 2092, 16, 29, 29, 30, 31, 31, 31, 31, 32, 31, 31, 29, 30, 30 };
                    }

                case 2037:
                    {
                        return new int[15] { 2093, 17, 30, 29, 29, 31, 31, 31, 32, 31, 31, 31, 30, 29, 30 };
                    }

                case 2038:
                    {
                        return new int[15] { 2094, 17, 30, 29, 30, 30, 31, 31, 32, 32, 31, 30, 30, 29, 30 };
                    }

                case 2039:
                    {
                        return new int[15] { 2095, 17, 30, 29, 30, 30, 31, 32, 31, 32, 31, 30, 30, 30, 29 };
                    }

                case 2040:
                    {
                        return new int[15] { 2096, 16, 29, 29, 30, 31, 31, 31, 31, 32, 31, 31, 29, 30, 30 };
                    }

                case 2041:
                    {
                        return new int[15] { 2097, 17, 30, 29, 30, 30, 31, 31, 32, 31, 31, 31, 30, 29, 30 };
                    }

                case 2042:
                    {
                        return new int[15] { 2098, 17, 30, 29, 30, 30, 31, 31, 32, 32, 31, 30, 30, 29, 30 };
                    }

                case 2043:
                    {
                        return new int[15] { 2099, 17, 30, 29, 30, 30, 31, 32, 31, 32, 31, 30, 30, 30, 29 };
                    }

                case 2044:
                    {
                        return new int[15] { 2100, 16, 29, 29, 30, 31, 31, 31, 31, 32, 31, 31, 29, 30, 30 };
                    }

                case 2045:
                    {
                        return new int[15] { 2101, 17, 30, 29, 30, 30, 31, 31, 32, 31, 31, 31, 30, 29, 30 };
                    }

                case 2046:
                    {
                        return new int[15] { 2102, 17, 30, 29, 30, 30, 31, 32, 31, 32, 31, 30, 30, 29, 30 };
                    }

                case 2047:
                    {
                        return new int[15] { 2103, 17, 30, 29, 30, 30, 31, 32, 31, 32, 31, 30, 30, 30, 29 };
                    }

                case 2048:
                    {
                        return new int[15] { 2104, 16, 29, 30, 29, 31, 31, 31, 31, 32, 31, 31, 30, 29, 30 };
                    }

                case 2049:
                    {
                        return new int[15] { 2105, 17, 30, 29, 30, 30, 31, 31, 32, 31, 31, 32, 30, 29, 30 };
                    }

                case 2050:
                    {
                        return new int[15] { 2106, 17, 30, 29, 30, 30, 31, 32, 31, 32, 31, 30, 30, 30, 29 };
                    }

                case 2051:
                    {
                        return new int[15] { 2107, 16, 29, 29, 30, 30, 31, 32, 31, 32, 31, 30, 30, 30, 29 };
                    }

                case 2052:
                    {
                        return new int[15] { 2108, 16, 29, 30, 29, 31, 31, 31, 32, 31, 31, 31, 30, 29, 30 };
                    }

                case 2053:
                    {
                        return new int[15] { 2109, 17, 30, 29, 30, 30, 31, 31, 32, 31, 31, 31, 30, 29, 30 };
                    }

                case 2054:
                    {
                        return new int[15] { 2110, 17, 30, 29, 30, 30, 31, 32, 31, 32, 31, 30, 30, 30, 29 };
                    }

                default:
                    {
                        return new int[15] { 9999, 77, 77, 77, 77, 77, 77, 77, 77, 77, 77, 77, 77, 77, 77 };
                    }
            }
        }
